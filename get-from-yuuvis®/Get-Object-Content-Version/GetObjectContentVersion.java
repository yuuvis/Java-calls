...
public class GetObjectContentVersion
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            request = new Request.Builder().headers(headers).url(BASEURL + "/objects/" + objectId + "/versions/" + versionNumber + "/contents/file").get().build();
