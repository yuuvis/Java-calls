...
public class GetObjectContentDigestVersion
{
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            request = new Request.Builder().headers(headers).url(BASEURL + "/objects/" + objectId + "/versions/" + versionNumber + "/actions/validate/digest").get().build();
